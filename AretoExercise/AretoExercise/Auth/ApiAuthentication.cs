    ...
    public class ApiAuthentication : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            try
            {
                ...
                user = await _userService.AuthenticateUser(credentials[0], credentials[1]);
            }
            catch
            {
                return AuthenticateResult.Fail("Please provide valid Authorization header");
            }
